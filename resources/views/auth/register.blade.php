            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-9">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- select role --}}
                        <label for="email" class="mt-3 mb-2">{{ __('Role') }}</label>
                        <select name="role" id="role" class="form-select">
                            <option value="admin">admin</option>
                            <option value="admin">kasir</option>
                            <option value="admin">stockist</option>
                        </select>
                        ...
                        <input id="password-confirm" type="password" class="form-control" name="real_password" required autocomplete="new-password" placeholder="tulis ulang kembali password">

                        <!-- button register -->
                        <button type="submit" class="btn app-btn-primary mt-4">
                                    {{ __('Registrasi') }}
                        </button>
                    </form>
                </div>
