        ...
        <div class="container-xl">
            <div class="card app-card shadow-sm mb-4">
                ...
                <div class="app-card-body" style="padding: 10px 16px">
                    <form class="settings-form" method="POST" action="{{ url('stokkeluar') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row align-items-center">
                            <div class="col-6 col-xl-6 col-md-12 col-sm-12">
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input type="date" name="tgl_keluar" class="form-control mb-2" placeholder="masukkan tanggal keluar" required>
                                </div>
