            ...
            <div class="card app-card shadow-sm mb-4">
                <div class="header" style="border-bottom: 0.1px solid #e7e9ed">
                    <div class="row g-3 align-items-center px-3 py-2">
                        ...
                        <div class="col-12 col-lg-auto text-center text-lg-start">
                            <h6 class="mt-2">Tambah Stok Masuk</h6>
                        </div>
                    </div>
                </div>
                <div class="app-card-body" style="padding: 10px 16px">
                    <form class="settings-form" method="POST" action="{{ url('stokmasuk') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row align-items-center">
                            <div class="col-6 col-xl-6 col-md-12 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_staff" class="form-control mb-2" placeholder="masukkan nama staff" required>
                                </div>

                                {{-- input tgl masuk stok --}}
                                <div class="mt-3 mb-3">
                                    <label for="tgl_masuk" class="form-label mb-3" style="text-align: right;"><b>Tanggal Masuk</b></label>
                                    <input type="date" name="tgl_masuk" class="form-control mb-2" placeholder="masukkan tanggal masuk" required>
                                </div>

                                {{-- input catatan --}}
                                <div class="mb-3">
                                    <label for="catatan" class="form-label mb-3" style="text-align: right;"><b>Catatan</b></label>
                                    <input type="text" name="catatan" class="form-control mb-2" placeholder="masukkan catatan" required>
                                </div>

                                {{-- input qty --}}
                                <div class="mb-3">
                                    <label for="catatan" class="form-label mb-3" style="text-align: right;"><b>Jumlah Qty</b></label>
                                    <input type="number" name="qty" class="form-control mb-2" placeholder="masukkan jumlah qty" required>
                                </div>

                                {{-- input harga item --}}
                                <div class="mb-3">
                                    <label for="harga" class="form-label mb-3" style="text-align: right;"><b>Harga</b></label>
                                    <input type="number" name="harga" class="form-control mb-2" placeholder="masukkan harga item" required>
                                </div>

                                {{-- input penerima --}}
                                <div class="mb-3">
                                    <label for="diterimaoleh" class="form-label mb-3" style="text-align: right;"><b>Diterima Oleh</b></label>
                                    <input type="text" name="penerima" class="form-control mb-2" placeholder="masukkan nama penerima" required>
                                </div>
