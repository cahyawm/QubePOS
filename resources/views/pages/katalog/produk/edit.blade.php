        ...
        <div class="container-xl">
            <div class="card app-card shadow-sm mb-4">
                ...
                <div class="app-card-body" style="padding: 10px 16px">
                    <form class="settings-form" method="POST" action="{{ url('produk/'.$model->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row align-items-center">
                            <div class="col-6 col-xl-6 col-md-12 col-sm-12">
                                ...
                                {{-- select kategori --}}
                                <div class="mb-3">
                                    <label class="form-label mb-3" style="text-align: right;"><b>Kategori</b></label>
                                    <select name="kategori_id" class="form-select">
                                        @foreach ( $kategori as $kategori )
                                        <option value="{{ $kategori->id }}" {{ $kategori->id == $model->kategori_id ? 'selected' : ''}}>{{ $kategori->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                {{-- input  --}}
                                <div class="mt-3 mb-3">
                                    <label class="form-label mb-3" style="text-align: right;"><b>Harga Produk</b></label>
                                    <input type="text" name="harga" class="form-control mb-3" value="{{ $model->harga }}">
                                </div>

                                {{-- input --}}
                                <div class="mb-3">
                                    <label class="form-label mb-3"><b>Upload File Gambar</b></label>
